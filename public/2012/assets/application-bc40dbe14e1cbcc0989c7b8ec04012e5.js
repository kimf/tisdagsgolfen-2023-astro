...
!(function (e, t) {
  ...
  function a() {
    ht.addEventListener
      ? (ht.removeEventListener('DOMContentLoaded', s, !1), e.removeEventListener('load', s, !1))
      : (ht.detachEvent('onreadystatechange', s), e.detachEvent('onload', s));
  }
  function s() {
    (ht.addEventListener || 'load' === event.type || 'complete' === ht.readyState) &&
      (a(), it.ready());
  }
  function l(e, t, n) {
  ...
  function c(e, t, n, r) {
    if (it.acceptData(e)) {
      ...
      if ((u && l[u] && (r || l[u].data)) || void 0 !== n || 'string' != typeof t)
        return (
          u || (u = s ? (e[a] = Y.pop() || it.guid++) : a),
          l[u] || (l[u] = s ? {} : { toJSON: it.noop }),
          ('object' == typeof t || 'function' == typeof t) &&
            (r ? (l[u] = it.extend(l[u], t)) : (l[u].data = it.extend(l[u].data, t))),
          (o = l[u]),
  ...
  function N(e) {
    ...
    return (
      n ||
        ((n = E(e, t)),
        ('none' !== n && n) ||
          ((Kt = (Kt || it("<iframe frameborder='0' width='0' height='0'/>")).appendTo(
            t.documentElement
          )),
        ...
        r.style &&
          ...
          t
            ? (o[a] || 'none' !== n || (r.style.display = ''),
              '' === r.style.display && Dt(r) && (o[a] = it._data(r, 'olddisplay', N(r.nodeName))))
            : ((i = Dt(r)),
              ((n && 'none' !== n) || !i) &&
      ...
      'margin' === n && (a += it.css(e, n + St[o], !0, i)),
        r
          ? ('content' === n && (a -= it.css(e, 'padding' + St[o], !0, i)),
            'margin' !== n && (a -= it.css(e, 'border' + St[o] + 'Width', !0, i)))
  ...
  function O(e, t, n) {
    ...
    n.queue ||
      ...
      1 === e.nodeType &&
        ...
        (u = it.css(e, 'display')),
        (c = 'none' === u ? it._data(e, 'olddisplay') || N(e.nodeName) : u),
        'inline' === c &&
          'none' === it.css(e, 'float') &&
          (nt.inlineBlockNeedsLayout && 'inline' !== N(e.nodeName)
            ? (p.zoom = 1)
    ...
    if (it.isEmptyObject(f)) 'inline' === ('none' === u ? N(e.nodeName) : u) && (p.display = u);
    else {
      ...
      for (r in f)
        (a = I(h ? m[r] : 0, r, d)),
          r in m ||
            ((m[r] = a.start),
            h && ((a.end = a.start), (a.start = 'width' === r || 'height' === r ? 1 : 0)));
    }
  }
  function _(e, t) {
    var n, r, i, o, a;
  ...
  function q(e, t, n) {
    var r,
      ...
      c = u.props;
    for (_(c, u.opts.specialEasing); a > o; o++) if ((r = bn[o].call(u, e, c, u.opts))) return r;
    return (
      it.map(c, I, u),
      it.isFunction(u.opts.start) && u.opts.start.call(e, u),
      it.fx.timer(it.extend(l, { elem: e, anim: u, queue: u.opts.queue })),
      u
  ...
  (it.fn = it.prototype =
          ...
          if (null != (i = arguments[s]))
            for (r in i)
              (e = a[r]),
                (n = i[r]),
                a !== n &&
                  (u && n && (it.isPlainObject(n) || (t = it.isArray(n)))
                    ? (t
    ...
    it.extend({
      ...
      makeArray: function (e, t) {
        var r = t || [];
        return (
          null != e && (n(Object(e)) ? it.merge(r, 'string' == typeof e ? [e] : e) : J.call(r, e)),
          r
        );
      },
  ...
  var ut =
    ...
    (function (e) {
        ...
        return t.first
          ...
          : function (t, n, a) {
              ...
              if (a) {
                ...
                for (; (t = t[r]); )
                  if (1 === t.nodeType || i) {
                    if (((l = t[B] || (t[B] = {})), (s = l[r]) && s[0] === P && s[1] === o))
                      return (u[2] = s[2]);
      ...
      try {
        Z.apply((Q = et.call(M.childNodes)), M.childNodes), Q[M.childNodes.length].nodeType;
      } catch (Ct) {
        Z = {
          apply: Q.length
            ? function (e, t) {
      ...
      (w = t.support = {}),
            ...
            return n !== H && 9 === n.nodeType && n.documentElement
              ? ((H = n),
                ...
                (w.getElementsByClassName =
                  vt.test(n.getElementsByClassName) &&
                  i(function (e) {
                    return (
                ...
                (T.find.CLASS =
                  w.getElementsByClassName &&
                  function (e, t) {
                    return typeof t.getElementsByClassName !== U && $
                ...
                (t = vt.test(F.compareDocumentPosition)),
                (q =
                  t || vt.test(F.contains)
                    ? function (e, t) {
                      ...
                      return r
                        ...
                        : ((r =
                          ...
                          1 & r || (!w.sortDetached && t.compareDocumentPosition(e) === r)
                            ? e === n || (e.ownerDocument === M && q(M, e))
                              ? -1
                              : t === n || (t.ownerDocument === M && q(M, t))
                                ? 1
                                : j
                                  ? tt.call(j, e) - tt.call(j, t)
                                  : 0
                            : 4 & r
                              ? -1
                              : 1);
        ...
        (t.matchesSelector = function (e, n) {
          if (
            ...
            (n = n.replace(dt, "='$1']")),
            !(!w.matchesSelector || !$ || (O && O.test(n)) || (I && I.test(n))))
          )
            try {
              var r = _.call(e, n);
        ...
        (t.contains = function (e, t) {
          return (e.ownerDocument || e) !== H && A(e), q(e, t);
        }),
        (t.attr = function (e, t) {
          (e.ownerDocument || e) !== H && A(e);
          var n = T.attrHandle[t.toLowerCase()],
            r = n && G.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !$) : void 0;
          return void 0 !== r
            ? r
            : w.attributes || !$
              ? e.getAttribute(t)
                ...
                return 1 === r && 0 === i
                  ...
                  : function (t, n, l) {
                      ...
                      if (g) {
                        ...
                        } else if (y && (u = (t[B] || (t[B] = {}))[e]) && u[0] === P) f = u[1];
                        else
                          for (
                            ;
                            (d = (++p && d && d[m]) || (f = p = 0) || h.pop()) &&
      ...
      return (
        ...
        (S = t.select =
          function (e, t, n, r) {
            ...
            return (u || k(e, d))(r, t, !$, n, (bt.test(e) && c(t.parentNode)) || t), n;
          }),
      ...
      d = {
        ...
        fireWith: function (e, n) {
          return (
            !l ||
              (r && !u) ||
              ((n = n || []), (n = [e, n.slice ? n.slice() : n]), t ? u.push(n) : c(n)),
            this
          );
        },
        fire: function () {
        ...
        if (void 0 === e) {
          if (this.length && ((i = it.data(o)), 1 === o.nodeType && !it._data(o, 'parsedAttrs'))) {
            for (n = a.length; n--; )
              a[n] &&
                ((r = a[n].name),
                0 === r.indexOf('data-') && ((r = it.camelCase(r.slice(5))), l(o, r, i[r])));
  ...
  (it.event = {
        ...
        for (
          n.handler && ((l = n), (n = l.handler), (i = l.selector)),
            ...
            (c = g.handle) ||
              ((c = g.handle =
                function (e) {
                  return typeof it === Ct || (e && it.event.triggered === e.type)
                    ? void 0
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (g && (c = g.events)) {
        for (t = (t || '').match(bt) || [''], u = t.length; u--; )
          if (
            ((s = It.exec(t[u]) || []), (p = m = s[1]), (h = (s[2] || '').split('.').sort()), p)
          ) {
            for (
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !u.noBubble && !it.isWindow(r)) {
          for (l = u.delegateType || p, $t.test(l + p) || (s = s.parentNode); s; s = s.parentNode)
            f.push(s), (c = s);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = it.event.handlers.call(this, e, l), t = 0;
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a = Ft.test(i) ? this.mouseHooks : Ht.test(i) ? this.keyHooks : {}),
    ...
    it.extend({
      clone: function (e, t, n) {
        var r,
          ...
          a,
          s,
          l = it.contains(e.ownerDocument, e);
        if (
          (nt.html5Clone || it.isXMLDoc(e) || !qt.test('<' + e.nodeName + '>')
            ? (o = e.cloneNode(!0))
            : ((Jt.innerHTML = e.outerHTML), Jt.removeChild((o = Jt.firstChild))),
          !(
        ...
        return (
          (r = g(o, 'script')), r.length > 0 && w(r, !l && g(e, 'script')), (r = s = i = null), o
        );
      },
      buildFragment: function (e, t, n, r) {
            ...
            if ('object' === it.type(o)) it.merge(p, o.nodeType ? [o] : o);
              ...
              for (
                s = s || f.appendChild(t.createElement('div')),
                  l = (Pt.exec(o) || ['', ''])[1].toLowerCase(),
                  c = Gt[l] || Gt._default,
                  s.innerHTML = c[1] + o.replace(Mt, '<$1></$2>') + c[2],
                  i = c[0];
                i--;
                ...
                s = s.lastChild;
              if (
                (!nt.leadingWhitespace && Bt.test(o) && p.push(t.createTextNode(Bt.exec(o)[0])),
                !nt.tbody)
              )
                for (
                  o =
                  ...
                  it.nodeName((u = o.childNodes[i]), 'tbody') &&
                    !u.childNodes.length &&
                    o.removeChild(u);
        ...
        for (
          s && f.removeChild(s), nt.appendChecked || it.grep(g(p, 'input'), v), h = 0;
          (o = p[h++]);
      ...
      text: function (e) {
        return jt(
          ...
          function (e) {
            return void 0 === e
              ? it.text(this)
              : this.empty().append(((this[0] && this[0].ownerDocument) || ht).createTextNode(e));
          },
          null,
          e,
          arguments.length
          ...
          function (e) {
            ...
            if (
              !(
                'string' != typeof e ||
                zt.test(e) ||
                (!nt.htmlSerialize && qt.test(e)) ||
                (!nt.leadingWhitespace && Bt.test(e)) ||
                Gt[(Pt.exec(e) || ['', ''])[1].toLowerCase()]
              )
            ) {
              e = e.replace(Mt, '<$1></$2>');
              try {
              ...
              (r = o[l]),
                Vt.test(r.type || '') &&
                  ...
                  (r.src
                    ...
                    : it.globalEval(
                        (r.text || r.textContent || r.innerHTML || '').replace(Yt, '')
                      ));
          s = n = null;
        }
        return this;
      ...
      function (e, t) {
        it.fn[e] = function (e) {
          for (var n, r = 0, i = [], o = it(e), a = o.length - 1; a >= r; r++)
            (n = r === a ? this : this.clone(!0)), it(o[r])[t](n), J.apply(i, n.get());
  ...
  it.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          ((t = it.cssProps[s] || (it.cssProps[s] = S(l, s))),
    ...
    it.each(['height', 'width'], function (e, t) {
      it.cssHooks[t] = {
        get: function (e, n, r) {
          return n
            ? ln.test(it.css(e, 'display')) && 0 === e.offsetWidth
        ...
        set: function (e, n, r) {
          ...
          return j(
            e,
            n,
            r ? L(e, t, r, nt.boxSizing && 'border-box' === it.css(e, 'boxSizing', !1, i), i) : 0
          );
        }
      };
    }),
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : Dn.test(e.nodeName) || (jn.test(e.nodeName) && e.href)
                ? 0
                : -1;
          }
        }
  ...
  it.fn.extend({
      ...
      if (u)
        for (t = (e || '').match(bt) || []; l > s; s++)
          if (
            ((n = this[s]),
            (r =
              1 === n.nodeType && (n.className ? (' ' + n.className + ' ').replace(Ln, ' ') : ' ')))
          ) {
    ...
    hasClass: function (e) {
      for (var t = ' ' + e + ' ', n = 0, r = this.length; r > n; n++)
        if (
          1 === this[n].nodeType &&
          (' ' + this[n].className + ' ').replace(Ln, ' ').indexOf(t) >= 0
        )
          return !0;
      return !1;
    }
      ...
      ajax: function (e, t) {
        function n(e, t, n, r) {
          ...
          2 !== b &&
            ...
            m.fireWith(f, [w, T]),
            l && (p.trigger('ajaxComplete', [w, d]), --it.active || it.event.trigger('ajaxStop')));
        }
        ...
        if (
          ...
          (w.success = w.done),
          (w.error = w.fail),
          (d.url = ((e || d.url || In) + '').replace(On, '').replace(Pn, $n[1] + '//')),
        ...
        (l = d.global),
          ...
          (o = d.url),
          d.hasContent ||
            (d.data && ((o = d.url += (Hn.test(o) ? '&' : '?') + d.data), delete d.data),
            d.cache === !1 &&
              (d.url = _n.test(o)
                ? o.replace(_n, '$1_=' + An++)
                : o + (Hn.test(o) ? '&' : '?') + '_=' + An++)),
          ...
          w.setRequestHeader(
            ...
            d.dataTypes[0] && d.accepts[d.dataTypes[0]]
              ? d.accepts[d.dataTypes[0]] + ('*' !== d.dataTypes[0] ? ', ' + Xn + '; q=0.01' : '')
              : d.accepts['*']
          );
  ...
  (it.param = function (e, t) {
    ...
    (it.ajaxSettings.xhr =
      void 0 !== e.ActiveXObject
        ? function () {
            return (
              (!this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && X()) ||
              V()
            );
          }
        : X);
      ...
      return s || 'jsonp' === t.dataTypes[0]
        ? ((i = t.jsonpCallback =
          ...
          s
            ...
            : t.jsonp !== !1 && (t.url += (Hn.test(t.url) ? '&' : '?') + t.jsonp + '=' + i),
      ...
      offset: function (e) {
        ...
        if (o)
          return (
            (t = o.documentElement),
            it.contains(t, i)
              ? (typeof i.getBoundingClientRect !== Ct && (r = i.getBoundingClientRect()),
                (n = U(o)),
                {
        ...
        handleRemote: function (r) {
          ...
          if (n.fire(r, 'ajax:before')) {
            ...
            return (
              ...
              u && (d.xhrFields = { withCredentials: u }),
              o && (d.url = o),
              n.ajax(d)
            );
          }
            ...
            l.each(function () {
              if (
                ...
                if (
                  ...
                  l.filter('input[type=radio]:checked[name="' + i.attr('name') + '"]').length
                )
                  return !0;
                a = a.add(i);
              }
  ...
  (function ($) {
    $.extend({
      tablesorter: new (function () {
        ...
        function log(e) {
          'undefined' != typeof console && 'undefined' != typeof console.debug
            ? console.log(e)
            : alert(e);
        }
        function buildParserCache(e, t) {
          ...
          if (0 != e.tBodies.length) {
            ...
            if (r[0])
              for (var i = [], o = r[0].cells, a = o.length, s = 0; a > s; s++) {
                var l = !1;
                $.metadata && $(t[s]).metadata() && $(t[s]).metadata().sorter
                  ? (l = getParserById($(t[s]).metadata().sorter))
                  : e.config.headers[s] &&
                    e.config.headers[s].sorter &&
                    (l = getParserById(e.config.headers[s].sorter)),
                  l || (l = detectParserForColumn(e, r, -1, s)),
                  e.config.debug && (n += 'column:' + s + ' parser:' + l.id + '\n'),
                  i.push(l);
              }
        ...
        function detectParserForColumn(e, t, n, r) {
          for (var i = parsers.length, o = !1, a = !1, s = !0; '' == a && s; )
            n++,
              t[n]
                ? ((o = getNodeFromRowAndCellIndex(t, n, r)),
                  (a = trimAndGetNodeText(e.config, o)),
                  e.config.debug && log('Checking if value was empty on row:' + n))
                : (s = !1);
          for (var l = 1; i > l; l++) if (parsers[l].is(a, e, o)) return parsers[l];
          return parsers[0];
        }
        ...
        function getParserById(e) {
          for (var t = parsers.length, n = 0; t > n; n++)
        ...
        function buildCache(e) {
          ...
          for (
            ...
            if (s.hasClass(e.config.cssChildRow))
              ...
              o.row.push(s);
              for (var u = 0; r > u; ++u)
                l.push(i[u].format(getElementText(e.config, s[0].cells[u]), e, s[0].cells[u]));
              l.push(o.normalized.length), o.normalized.push(l), (l = null);
            }
          }
          return e.config.debug && benchmark('Building cache for ' + n + ' rows:', t), o;
        }
        ...
        function appendToTable(e, t) {
          ...
          for (
            ...
            var d = o[c][s];
            if ((u.push(i[d]), !e.config.appender))
              for (var f = i[d].length, p = 0; f > p; p++) l[0].appendChild(i[d][p]);
          }
        ...
        function buildHeaders(e) {
          if (e.config.debug) var t = new Date();
          var n = ($.metadata ? !0 : !1, computeTableHeaderCellIndexes(e));
          return (
            ($tableHeaders = $(e.config.selectorHeaders, e).each(function (t) {
              if (
                ...
                checkHeaderOptionsSortingLocked(e, t) &&
                  (this.order = this.lockedOrder = checkHeaderOptionsSortingLocked(e, t)),
                !this.sortDisabled)
              ) {
                var r = $(this).addClass(e.config.cssHeader);
                e.config.onRenderHeader && e.config.onRenderHeader.apply(r);
              }
        ...
        function computeTableHeaderCellIndexes(e) {
          for (
            ...
            for (var a = i[o].cells, s = 0; s < a.length; s++) {
              var l,
                u = a[s],
              ...
              for (var h = 0; h < t[c].length + 1; h++)
                if ('undefined' == typeof t[c][h]) {
                  l = h;
                  break;
                }
              n[d] = l;
              for (var h = c; c + f > h; h++) {
                'undefined' == typeof t[h] && (t[h] = []);
                for (var m = t[h], g = l; l + p > g; g++) m[g] = 'x';
              }
            }
          return n;
        }
        function checkCellColSpan(e, t, n) {
          for (var r = [], i = e.tHead.rows, o = i[n].cells, a = 0; a < o.length; a++) {
            var s = o[a];
            s.colSpan > 1
              ? (r = r.concat(checkCellColSpan(e, headerArr, n++)))
              : (1 == e.tHead.length || s.rowSpan > 1 || !i[n + 1]) && r.push(s);
          }
          return r;
        }
        ...
        function checkHeaderOptionsSortingLocked(e, t) {
          return e.config.headers[t] && e.config.headers[t].lockedOrder
            ? e.config.headers[t].lockedOrder
            : !1;
        }
        function applyWidget(e) {
          for (var t = e.config.widgets, n = t.length, r = 0; n > r; r++)
            getWidgetById(t[r]).format(e);
        }
        function getWidgetById(e) {
          for (var t = widgets.length, n = 0; t > n; n++)
        ...
        function isValueInArray(e, t) {
          for (var n = t.length, r = 0; n > r; r++) if (t[r][0] == e) return !0;
          return !1;
        }
        function setHeadersCss(e, t, n, r) {
          ...
          for (var o = n.length, a = 0; o > a; a++) i[n[a][0]].addClass(r[n[a][1]]);
        }
        ...
        function updateHeaderSortCount(e, t) {
          for (var n = e.config, r = t.length, i = 0; r > i; i++) {
            var o = t[i],
              a = n.headerList[o[0]];
            (a.count = o[1]), a.count++;
          }
        ...
        function multisort(table, sortList, cache) {
          ...
          for (
            var dynamicExp = 'var sortWrapper = function(a,b) {', l = sortList.length, i = 0;
            l > i;
            i++
          ) {
            var c = sortList[i][0],
        ...
        (this.defaults = {
            ...
            return this.each(function () {
              if (this.tHead && this.tBodies) {
                ...
                (this.config = {}),
                  ...
                  (n = buildHeaders(this)),
                  (this.config.parsers = buildParserCache(this, n)),
                  (r = buildCache(this));
                var o = [i.cssDesc, i.cssAsc];
                fixColumnWidth(this),
                  n
                    .click(function (e) {
                      ...
                      if (!this.sortDisabled && a > 0) {
                        ...
                        if (
                          ...
                          e[i.sortMultiSortKey])
                        )
                          if (isValueInArray(s, i.sortList))
                            for (var l = 0; l < i.sortList.length; l++) {
                              var u = i.sortList[l],
                                c = i.headerList[u[0]];
                              u[0] == s && ((c.count = u[1]), c.count++, (u[1] = c.count % 2));
                            }
                          else i.sortList.push([s, this.order]);
                        else {
                          if (((i.sortList = []), null != i.sortForce))
                            for (var d = i.sortForce, l = 0; l < d.length; l++)
                              d[l][0] != s && i.sortList.push(d[l]);
                          i.sortList.push([s, this.order]);
                        }
                        return (
                          setTimeout(function () {
                            setHeadersCss(t[0], n, i.sortList, o),
                              appendToTable(t[0], multisort(t[0], i.sortList, r));
                          }, 1),
                          !1
                        );
                      }
                  ...
                  t
                    .bind('update', function () {
                      var e = this;
                      setTimeout(function () {
                        (e.config.parsers = buildParserCache(e, n)), (r = buildCache(e));
                      }, 1);
                    })
                    .bind('updateCell', function (e, t) {
                      var n = this.config,
                        i = [t.parentNode.rowIndex - 1, t.cellIndex];
                      r.normalized[i[0]][i[1]] = n.parsers[i[1]].format(getElementText(n, t), t);
                    })
                    .bind('sorton', function (e, t) {
                      $(this).trigger('sortStart'), (i.sortList = t);
                      var a = i.sortList;
                      updateHeaderSortCount(this, a),
                        setHeadersCss(this, n, a, o),
                        appendToTable(this, multisort(this, a, r));
                    })
                    .bind('appendCache', function () {
                      appendToTable(this, r);
                    })
                  ...
                  $.metadata &&
                    ...
                    (i.sortList = $(this).metadata().sortlist),
          ...
          (this.addParser = function (e) {
            for (var t = parsers.length, n = !0, r = 0; t > r; r++)
    ...
    ts.addParser({
      ...
      ts.addParser({
        ...
        format: function (e) {
          return $.tablesorter.formatFloat(e.replace(new RegExp(/[\xa3$\u20ac]/g), ''));
        },
        type: 'numeric'
      }),
      ts.addParser({
        ...
        format: function (e) {
          for (var t = e.split('.'), n = '', r = t.length, i = 0; r > i; i++) {
            var o = t[i];
            n += 2 == o.length ? '0' + o : o;
          }
      ...
      ts.addParser({
        ...
        format: function (e) {
          return $.tablesorter.formatFloat(
            '' != e ? new Date(e.replace(new RegExp(/-/g), '/')).getTime() : '0'
          );
        },
        type: 'numeric'
      }),
          ...
          return (
            ...
            'us' == n.dateFormat
              ...
              : 'uk' == n.dateFormat
                ...
                : ('dd/mm/yy' == n.dateFormat || 'dd-mm-yy' == n.dateFormat) &&
      ...
      ts.addWidget({
        ...
        format: function (e) {
          ...
          $('tr:visible', e.tBodies[0]).each(function () {
            (n = $(this)),
              n.hasClass(e.config.cssChildRow) || i++,
              (r = i % 2 == 0),
              n
                .removeClass(e.config.widgetZebra.css[r ? 0 : 1])
                .addClass(e.config.widgetZebra.css[r ? 1 : 0]);
          }),
  ...
  jQuery(function () {
    $('table.leaderboard').addClass('tablesorter').tablesorter(),
      $('table.rounds')
        .addClass('tablesorter')
        .tablesorter({ headers: { 0: { sorter: 'round-date' } } });
  }),
