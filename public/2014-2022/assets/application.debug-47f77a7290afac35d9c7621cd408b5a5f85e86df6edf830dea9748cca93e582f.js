(() => {
        ...
        (function () {
          ...
          (function () {
            var disableFormElement,
              ...
              stopEverything;
            (matches = Rails2.matches),
              (getData = Rails2.getData),
              (setData = Rails2.setData),
              (stopEverything = Rails2.stopEverything),
              (formElements = Rails2.formElements);
            ...
            Rails2.enableElement = function (e) {
              ...
              if (matches(element, Rails2.linkDisableSelector)) {
                ...
                matches(element, Rails2.buttonDisableSelector) ||
                matches(element, Rails2.formEnableSelector)
              ) {
            ...
            Rails2.disableElement = function (e) {
              ...
              if (matches(element, Rails2.linkDisableSelector)) {
                ...
                matches(element, Rails2.buttonDisableSelector) ||
                matches(element, Rails2.formDisableSelector)
              ) {
          ...
          (function () {
            ...
            (matches = Rails2.matches),
              ...
              (stopEverything = Rails2.stopEverything),
              (ajax = Rails2.ajax),
              (isCrossDomain = Rails2.isCrossDomain),
              (serializeElement = Rails2.serializeElement);
            ...
            Rails2.handleRemote = function (e) {
              ...
              if (matches(element, Rails2.formSubmitSelector)) {
                ...
                matches(element, Rails2.buttonClickSelector) ||
                matches(element, Rails2.inputChangeSelector)
              ) {
          ...
          (function () {
            var $2,
              ...
              refreshCSRFTokens;
            (fire = Rails2.fire),
              (delegate = Rails2.delegate),
              (getData = Rails2.getData),
              ($2 = Rails2.$),
              (refreshCSRFTokens = Rails2.refreshCSRFTokens),
              (CSRFProtection = Rails2.CSRFProtection),
              (loadCSPNonce = Rails2.loadCSPNonce),
              (enableElement = Rails2.enableElement),
              (disableElement = Rails2.disableElement),
              (handleDisabledElement = Rails2.handleDisabledElement),
              (handleConfirm = Rails2.handleConfirm),
              (preventInsignificantClick = Rails2.preventInsignificantClick),
              (handleRemote = Rails2.handleRemote),
              (formSubmitButtonClick = Rails2.formSubmitButtonClick),
              (handleMethod = Rails2.handleMethod);
      ...
      (function (global, factory) {
        ...
        var Subscriptions = (function () {
          ...
          Subscriptions2.prototype.create = function create(channelName, mixin) {
            ...
            var params =
              (typeof channel === 'undefined' ? 'undefined' : _typeof(channel)) === 'object'
                ? channel
                : {
                    channel
                  };
          ...
          Subscriptions2.prototype.notify = function notify(subscription, callbackName) {
            ...
            return subscriptions.map(function (subscription2) {
              return typeof subscription2[callbackName] === 'function'
                ? subscription2[callbackName].apply(subscription2, args)
                : void 0;
            });
          };
          ...
          (function () {
            ...
            (e.copyObject = function (t3) {
              ...
              (e.throttle = function (t3) {
                ...
                return (
                  ...
                  function () {
                    var r2;
                    return (
                      (r2 = 1 <= arguments.length ? o.call(arguments, 0) : []),
                      null != e2
                        ? e2
              ...
              (n = (function () {
                var t3;
                return (
                  (t3 = document.createEvent('Events')),
                  t3.initEvent('test', true, true),
                  t3.preventDefault(),
                  t3.defaultPrevented
                );
              })()),
              ...
              (r = (function () {
                ...
                return (
                  ...
                  null !=
                  (e2 =
                    null != (r2 = null != (n2 = t3.matchesSelector) ? n2 : t3.webkitMatchesSelector)
                      ? r2
                      : t3.msMatchesSelector)
                    ? e2
                    : t3.mozMatchesSelector
                );
              })()),
              (e.uuid = function () {
                var t3, e2, r2;
              ...
              e.Location = (function () {
                function t2(t3) {
                  ...
                  null == t3 && (t3 = ''),
                    ...
                    (r2.href = t3.toString()),
                    (this.absoluteURL = r2.href),
                    (e3 = r2.hash.length),
                    2 > e3
                      ? (this.requestURL = this.absoluteURL)
                      : ((this.requestURL = this.absoluteURL.slice(0, -e3)),
                        (this.anchor = r2.hash.slice(1)));
                }
                var e2, r, n, o;
                return (
                  (t2.wrap = function (t3) {
                  ...
                  (t2.prototype.getExtension = function () {
                    ...
                    return null !=
                      (t3 =
                        null != (e3 = this.getLastPathComponent().match(/\.[^.]*$/))
                          ? e3[0]
                          : void 0)
                      ? t3
                      : '';
            ...
            function () {
              ...
              e.HttpRequest = (function () {
                function r(r2, n, o) {
                  (this.delegate = r2),
                    (this.requestCanceled = t2(this.requestCanceled, this)),
                    (this.requestTimedOut = t2(this.requestTimedOut, this)),
                    (this.requestFailed = t2(this.requestFailed, this)),
                    (this.requestLoaded = t2(this.requestLoaded, this)),
                    (this.requestProgressed = t2(this.requestProgressed, this)),
                ...
                return (
                  ...
                  (r.prototype.send = function () {
                    ...
                    return this.xhr && !this.sent
                      ? (this.notifyApplicationBeforeRequestStart(),
                        ...
                        this.xhr.send(),
                        (this.sent = true),
                        'function' == typeof (t3 = this.delegate).requestStarted
                          ? t3.requestStarted()
                          : void 0)
                      : void 0;
                  }),
                  ...
                  (r.prototype.requestLoaded = function () {
                    return this.endRequest(
                      (function (t3) {
                        return function () {
                          var e2;
                          return 200 <= (e2 = t3.xhr.status) && 300 > e2
                            ? t3.delegate.requestCompletedWithResponse(
                                t3.xhr.responseText,
                                t3.xhr.getResponseHeader('Turbolinks-Location')
                              )
                            : ((t3.failed = true),
                              t3.delegate.requestFailedWithStatusCode(
                                t3.xhr.status,
                                t3.xhr.responseText
                              ));
                        };
                    ...
                    return this.endRequest(
                      (function (t3) {
                        return function () {
                          return (
                            (t3.failed = true),
                            t3.delegate.requestFailedWithStatusCode(t3.constructor.NETWORK_FAILURE)
                          );
                        };
                      })(this)
                    );
                    ...
                    return this.endRequest(
                      (function (t3) {
                        return function () {
                          return (
                            (t3.failed = true),
                            t3.delegate.requestFailedWithStatusCode(t3.constructor.TIMEOUT_FAILURE)
                          );
                        };
                      })(this)
                    );
                  ...
                  (r.prototype.setProgress = function (t3) {
                    ...
                    return (
                      (this.progress = t3),
                      'function' == typeof (e2 = this.delegate).requestProgressed
                        ? e2.requestProgressed(this.progress)
                        : void 0
                    );
                  }),
                  (r.prototype.destroy = function () {
                    ...
                    return (
                      this.setProgress(1),
                      'function' == typeof (t3 = this.delegate).requestFinished &&
                        t3.requestFinished(),
                      (this.delegate = null),
                      (this.xhr = null)
                    );
            ...
            function () {
              ...
              e.ProgressBar = (function () {
                function e2() {
                  (this.trickle = t2(this.trickle, this)),
                ...
                return (
                  ...
                  (e2.prototype.createStylesheetElement = function () {
                    ...
                    return (
                      ...
                      (t3.type = 'text/css'),
                      (t3.textContent = this.constructor.defaultCSS),
                      t3
                    );
                  }),
                  (e2.prototype.createProgressElement = function () {
                    ...
                    return (
                      ...
                      (t3.className = 'turbolinks-progress-bar'),
                      t3
                    );
                  }),
                  e2
            ...
            function () {
              ...
              e.BrowserAdapter = (function () {
                function r(r2) {
                  (this.controller = r2),
                    (this.showProgressBar = t2(this.showProgressBar, this)),
                ...
                return (
                  ...
                  (n = i.NETWORK_FAILURE),
                  (o = i.TIMEOUT_FAILURE),
                  (r.prototype.visitProposedToLocationWithAction = function (t3, e2) {
                  ...
                  (r.prototype.visitRequestStarted = function (t3) {
                    return (
                      ...
                      t3.hasCachedSnapshot() || 'restore' !== t3.action
            ...
            function () {
              ...
              e.History = (function () {
                function r(e2) {
                  (this.delegate = e2),
                    (this.onPageLoad = t2(this.onPageLoad, this)),
                    (this.onPopState = t2(this.onPopState, this));
                }
                return (
                  ...
                  (r.prototype.onPopState = function (t3) {
                    ...
                    return this.shouldHandlePopState() &&
                      (i = null != (n = t3.state) ? n.turbolinks : void 0)
                      ? ((r2 = e.Location.wrap(window.location)),
                        (o = i.restorationIdentifier),
                        this.delegate.historyPoppedToLocationWithRestorationIdentifier(r2, o))
                      : void 0;
                  }),
                  ...
                  (r.prototype.update = function (t3, e2, r2) {
                    var n;
                    return (
                      (n = { turbolinks: { restorationIdentifier: r2 } }),
                      history[t3 + 'State'](n, null, e2)
                    );
                  }),
                  r
                );
            ...
            function () {
              e.HeadDetails = (function () {
                ...
                var e2, r, n, o, i;
                return (
                  (t2.fromHeadElement = function (t3) {
                    var e3;
                  ...
                  (t2.prototype.getElementsMatchingTypeNotInDetails = function (t3, e3) {
                    ...
                    for (n2 in o2)
                      (i2 = o2[n2]),
                        (a = i2.type),
                        (r2 = i2.elements),
                        a !== t3 || e3.hasElementWithKey(n2) || s.push(r2[0]);
                    return s;
                  }),
                  (t2.prototype.getProvisionalElements = function () {
                    ...
                    for (e3 in n2)
                      (o2 = n2[e3]),
                        ...
                        (t3 = o2.elements),
                        null != s || i2
                          ? t3.length > 1 && r2.push.apply(r2, t3.slice(1))
                          : r2.push.apply(r2, t3);
                    return r2;
                  }),
                  (t2.prototype.getMetaValue = function (t3) {
                    var e3;
                    return null != (e3 = this.findMetaElementByName(t3))
                      ? e3.getAttribute('content')
                      : void 0;
                  }),
                  ...
                  (n = function (t3) {
                    var e3;
                    return (
                      (e3 = t3.tagName.toLowerCase()),
                      'style' === e3 || ('link' === e3 && 'stylesheet' === t3.getAttribute('rel'))
                    );
                  }),
                  (e2 = function (t3, e3) {
                    var r2;
                    return (
                      (r2 = t3.tagName.toLowerCase()),
                      'meta' === r2 && t3.getAttribute('name') === e3
                    );
                  }),
                  t2
                );
                ...
                return (
                  (t2.wrap = function (t3) {
                    return t3 instanceof this
                      ? t3
                      : 'string' == typeof t3
                        ? this.fromHTMLString(t3)
                        : this.fromHTMLElement(t3);
                  }),
                  (t2.fromHTMLString = function (t3) {
                    var e2;
                    return (
                      (e2 = document.createElement('html')),
                      (e2.innerHTML = t3),
                      this.fromHTMLElement(e2)
                    );
                  }),
                  (t2.fromHTMLElement = function (t3) {
                    var r, n, o, i;
                    return (
                      (o = t3.querySelector('head')),
                      (r =
                        null != (i = t3.querySelector('body'))
                          ? i
                  ...
                  (t2.prototype.getRootLocation = function () {
                    var t3, r;
                    return (
                      (r = null != (t3 = this.getSetting('root')) ? t3 : '/'), new e.Location(r)
                    );
                  }),
                ...
                return (
                  (e2.render = function () {
                    ...
                    return (
                      (n = arguments[0]),
                      (r2 = arguments[1]),
                      (e3 = 3 <= arguments.length ? t2.call(arguments, 2) : []),
                      (o = (function (t3, e4, r3) {
                  ...
                  (e2.prototype.createScriptElement = function (t3) {
                    var e3;
                    return 'false' === t3.getAttribute('data-turbolinks-eval')
                      ? t3
              ...
              (e.SnapshotRenderer = (function (e2) {
                ...
                return (
                        ...
                        this.renderView(
                          (function (e3) {
                            return function () {
                              return (
                                e3.replaceBody(),
                                e3.isPreview || e3.focusFirstAutofocusableElement(),
                                t3()
                              );
                            };
                          })(this)
                  ...
                  (o2.prototype.replaceBody = function () {
                    var t3;
                    return (
                      (t3 = this.relocateCurrentBodyPermanentElements()),
                      this.activateNewBodyScriptElements(),
                      this.assignNewBody(),
                      this.replacePlaceholderElementsWithClonedPermanentElements(t3)
                    );
                  }),
                  ...
                  (o2.prototype.copyNewHeadStylesheetElements = function () {
                    var t3, e3, r2, n2, o3;
                    for (
                      n2 = this.getNewHeadStylesheetElements(), o3 = [], e3 = 0, r2 = n2.length;
                      r2 > e3;
                      e3++
                    )
                  ...
                  (o2.prototype.copyNewHeadScriptElements = function () {
                    var t3, e3, r2, n2, o3;
                    for (
                      n2 = this.getNewHeadScriptElements(), o3 = [], e3 = 0, r2 = n2.length;
                      r2 > e3;
                      e3++
                    )
                      (t3 = n2[e3]),
                        o3.push(document.head.appendChild(this.createScriptElement(t3)));
                    return o3;
                  }),
                  (o2.prototype.removeCurrentHeadProvisionalElements = function () {
                    var t3, e3, r2, n2, o3;
                    for (
                      n2 = this.getCurrentHeadProvisionalElements(),
                        o3 = [],
                        e3 = 0,
                        r2 = n2.length;
                      r2 > e3;
                  ...
                  (o2.prototype.copyNewHeadProvisionalElements = function () {
                    var t3, e3, r2, n2, o3;
                    for (
                      n2 = this.getNewHeadProvisionalElements(), o3 = [], e3 = 0, r2 = n2.length;
                      r2 > e3;
                      e3++
                    )
                      (t3 = n2[e3]), o3.push(document.head.appendChild(t3));
                  ...
                  (o2.prototype.relocateCurrentBodyPermanentElements = function () {
                    ...
                    for (
                      a = this.getCurrentBodyPermanentElements(), u = [], e3 = 0, n2 = a.length;
                      n2 > e3;
                      e3++
                    )
                      (i = a[e3]),
                        (s = t2(i)),
                        (o3 = this.newSnapshot.getPermanentElementById(i.id)),
                        r(i, s.element),
                        r(o3, i),
                        u.push(s);
                    return u;
                  }),
                  (o2.prototype.replacePlaceholderElementsWithClonedPermanentElements = function (
                    t3
                  ) {
                    var e3, n2, o3, i, s, a, u;
                  ...
                  (o2.prototype.activateNewBodyScriptElements = function () {
                    var t3, e3, n2, o3, i, s;
                    for (
                      i = this.getNewBodyScriptElements(), s = [], e3 = 0, o3 = i.length;
                      o3 > e3;
                      e3++
                    )
                  ...
                  (o2.prototype.focusFirstAutofocusableElement = function () {
                    var t3;
                    return null != (t3 = this.newSnapshot.findFirstAutofocusableElement())
                      ? t3.focus()
                      : void 0;
                  }),
                ...
                (t2 = function (t3) {
                  var e2;
                  return (
                    (e2 = document.createElement('meta')),
                    e2.setAttribute('name', 'turbolinks-permanent-placeholder'),
                    e2.setAttribute('content', t3.id),
                    { element: e2, permanentElement: t3 }
                  );
                }),
                (r = function (t3, e2) {
                  var r2;
            ...
            function () {
              ...
              e.ErrorRenderer = (function (e2) {
                function r2(t3) {
                  var e3;
                  (e3 = document.createElement('html')),
                    (e3.innerHTML = t3),
                    (this.newHead = e3.querySelector('head')),
                    (this.newBody = e3.querySelector('body'));
                }
                return (
                  t2(r2, e2),
                  ...
                  (r2.prototype.replaceHeadAndBody = function () {
                    ...
                    return (
                      (e3 = document.head),
                      (t3 = document.body),
                      e3.parentNode.replaceChild(this.newHead, e3),
                      t3.parentNode.replaceChild(this.newBody, t3)
                    );
                  }),
                  (r2.prototype.activateBodyScriptElements = function () {
                    ...
                    for (n = this.getScriptElements(), i = [], e3 = 0, r3 = n.length; r3 > e3; e3++)
                      (o = n[e3]),
                        (t3 = this.createScriptElement(o)),
                        i.push(o.parentNode.replaceChild(t3, o));
                    return i;
                  }),
                ...
                return (
                  ...
                  (t2.prototype.render = function (t3, e2) {
                    ...
                    return (
                      ...
                      null != o ? this.renderSnapshot(o, n, e2) : this.renderError(r, e2)
                    );
                  }),
            ...
            function () {
              ...
              e.ScrollManager = (function () {
                function r(r2) {
                  (this.delegate = r2),
                    (this.onScroll = t2(this.onScroll, this)),
                ...
                return (
                  ...
                  (r.prototype.updatePosition = function (t3) {
                    ...
                    return (
                      (this.position = t3),
                      null != (e2 = this.delegate)
                        ? e2.scrollPositionChanged(this.position)
                        : void 0
                    );
                  }),
                  r
              ...
              e.SnapshotCache = (function () {
                ...
                return (
                  ...
                  (t2.prototype.touch = function (t3) {
                    ...
                    return (
                      (n = r(t3)),
                      (e2 = this.keys.indexOf(n)),
                      e2 > -1 && this.keys.splice(e2, 1),
                      this.keys.unshift(n),
                      this.trim()
                    );
                  }),
                  (t2.prototype.trim = function () {
                    var t3, e2, r2, n, o;
                    for (
                      n = this.keys.splice(this.size), o = [], t3 = 0, r2 = n.length;
                      r2 > t3;
                      t3++
                    )
            ...
            function () {
              ...
              e.Visit = (function () {
                function r(r2, n2, o) {
                  (this.controller = r2),
                    (this.action = o),
                    (this.performScroll = t2(this.performScroll, this)),
                    (this.identifier = e.uuid()),
                    (this.location = e.Location.wrap(n2)),
                ...
                return (
                  ...
                  (r.prototype.cancel = function () {
                    ...
                    return 'started' === this.state
                      ? (null != (t3 = this.request) && t3.cancel(),
                        this.cancelRender(),
                        (this.state = 'canceled'))
                      : void 0;
                  }),
                  (r.prototype.complete = function () {
                    ...
                    return 'started' === this.state
                      ? (this.recordTimingMetric('visitEnd'),
                        ...
                        'function' == typeof (t3 = this.adapter).visitCompleted &&
                          t3.visitCompleted(this),
                  ...
                  (r.prototype.fail = function () {
                    ...
                    return 'started' === this.state
                      ? ((this.state = 'failed'),
                        'function' == typeof (t3 = this.adapter).visitFailed
                          ? t3.visitFailed(this)
                          : void 0)
                      : void 0;
                  }),
                  (r.prototype.changeHistory = function () {
                    ...
                    return this.historyChanged
                      ? void 0
                      : ((t3 = this.location.isEqualTo(this.referrer) ? 'replace' : this.action),
                        (e2 = n(t3)),
                        this.controller[e2](this.location, this.restorationIdentifier),
                        (this.historyChanged = true));
                  }),
                  (r.prototype.issueRequest = function () {
                    return this.shouldIssueRequest() && null == this.request
                      ? ((this.progress = 0),
                        (this.request = new e.HttpRequest(this, this.location, this.referrer)),
                        this.request.send())
                      : void 0;
                  }),
                  (r.prototype.getCachedSnapshot = function () {
                    var t3;
                    return !(t3 = this.controller.getCachedSnapshotForLocation(this.location)) ||
                      (null != this.location.anchor && !t3.hasAnchor(this.location.anchor)) ||
                      ('restore' !== this.action && !t3.isPreviewable())
                      ? void 0
                      : t3;
                  }),
                  ...
                  (r.prototype.loadCachedSnapshot = function () {
                    var t3, e2;
                    return (e2 = this.getCachedSnapshot())
                      ? ((t3 = this.shouldIssueRequest()),
                        this.render(function () {
                          var r2;
                          return (
                            this.cacheSnapshot(),
                            this.controller.render(
                              { snapshot: e2, isPreview: t3 },
                              this.performScroll
                            ),
                            'function' == typeof (r2 = this.adapter).visitRendered &&
                              r2.visitRendered(this),
                            t3 ? void 0 : this.complete()
                          );
                        }))
                      : void 0;
                  }),
                          ...
                          return (
                            ...
                            this.request.failed
                              ? (this.controller.render(
                                ...
                                'function' == typeof (t3 = this.adapter).visitRendered &&
                                  t3.visitRendered(this),
                                this.fail())
                              : (this.controller.render(
                                  { snapshot: this.response },
                                  this.performScroll
                                ),
                                'function' == typeof (e2 = this.adapter).visitRendered &&
                                  e2.visitRendered(this),
                                this.complete())
                          );
                        })
                      : void 0;
                  ...
                  (r.prototype.requestStarted = function () {
                    ...
                    return (
                      ...
                      'function' == typeof (t3 = this.adapter).visitRequestStarted
                        ? t3.visitRequestStarted(this)
                        : void 0
                    );
                  }),
                  (r.prototype.requestProgressed = function (t3) {
                    ...
                    return (
                      (this.progress = t3),
                      'function' == typeof (e2 = this.adapter).visitRequestProgressed
                        ? e2.visitRequestProgressed(this)
                        : void 0
                    );
                  }),
                  (r.prototype.requestCompletedWithResponse = function (t3, r2) {
                    return (
                      (this.response = t3),
                      null != r2 && (this.redirectedToLocation = e.Location.wrap(r2)),
                      this.adapter.visitRequestCompleted(this)
                    );
                  }),
                  (r.prototype.requestFailedWithStatusCode = function (t3, e2) {
                    return (
                      (this.response = e2), this.adapter.visitRequestFailedWithStatusCode(this, t3)
                    );
                  }),
                  (r.prototype.requestFinished = function () {
                    ...
                    return (
                      ...
                      'function' == typeof (t3 = this.adapter).visitRequestFinished
                        ? t3.visitRequestFinished(this)
                        : void 0
                    );
                  }),
                  ...
                  (r.prototype.scrollToRestoredPosition = function () {
                    var t3, e2;
                    return (
                      (t3 = null != (e2 = this.restorationData) ? e2.scrollPosition : void 0),
                      null != t3 ? (this.controller.scrollToPosition(t3), true) : void 0
                    );
                  }),
                  (r.prototype.scrollToAnchor = function () {
                    return null != this.location.anchor
                      ? (this.controller.scrollToAnchor(this.location.anchor), true)
                      : void 0;
                  }),
                  ...
                  (r.prototype.recordTimingMetric = function (t3) {
                    var e2;
                    return null != (e2 = this.timingMetrics)[t3]
                      ? e2[t3]
                      : (e2[t3] = new Date().getTime());
                  }),
                  ...
                  (r.prototype.cacheSnapshot = function () {
                    return this.snapshotCached
                      ? void 0
                      : (this.controller.cacheSnapshot(), (this.snapshotCached = true));
                  }),
            ...
            function () {
              ...
              e.Controller = (function () {
                function r() {
                  (this.clickBubbled = t2(this.clickBubbled, this)),
                    (this.clickCaptured = t2(this.clickCaptured, this)),
                    (this.pageLoaded = t2(this.pageLoaded, this)),
                ...
                return (
                  ...
                  (r.prototype.visit = function (t3, r2) {
                    ...
                    return (
                      null == r2 && (r2 = {}),
                      (t3 = e.Location.wrap(t3)),
                      this.applicationAllowsVisitingLocation(t3)
                        ? this.locationIsVisitable(t3)
                          ? ((n = null != (o = r2.action) ? o : 'advance'),
                            this.adapter.visitProposedToLocationWithAction(t3, n))
                          : (window.location = t3)
                        : void 0
                    );
                  }),
                  (r.prototype.startVisitToLocationWithAction = function (t3, r2, n) {
                    ...
                    return e.supported
                      ? ((o = this.getRestorationDataForIdentifier(n)),
                        this.startVisit(t3, r2, { restorationData: o }))
                      : (window.location = t3);
                  }),
                  ...
                  (r.prototype.pushHistoryWithLocationAndRestorationIdentifier = function (t3, r2) {
                    return (
                      (this.restorationIdentifier = r2),
                      (this.location = e.Location.wrap(t3)),
                  ...
                  (r.prototype.cacheSnapshot = function () {
                    ...
                    return this.shouldCacheSnapshot()
                      ? (this.notifyApplicationBeforeCachingSnapshot(),
                        (r2 = this.view.getSnapshot()),
                        (t3 = this.lastRenderedLocation),
                        e.defer(
                          (function (e2) {
                            return function () {
                  ...
                  (r.prototype.scrollToAnchor = function (t3) {
                    var e2;
                    return (e2 = this.view.getElementForAnchor(t3))
                      ? this.scrollToElement(e2)
                  ...
                  (r.prototype.clickBubbled = function (t3) {
                    var e2, r2, n;
                    return this.enabled &&
                      this.clickEventIsSignificant(t3) &&
                      (r2 = this.getVisitableLinkForNode(t3.target)) &&
                      (n = this.getVisitableLocationForLink(r2)) &&
                      this.applicationAllowsFollowingLinkToLocation(r2, n)
                      ? (t3.preventDefault(),
                        (e2 = this.getActionForLink(r2)),
                        this.visit(n, { action: e2 }))
                      : void 0;
                  }),
                  (r.prototype.applicationAllowsFollowingLinkToLocation = function (t3, e2) {
                    var r2;
                    return (
                      (r2 = this.notifyApplicationAfterClickingLinkToLocation(t3, e2)),
                      !r2.defaultPrevented
                    );
                  }),
                  ...
                  (r.prototype.notifyApplicationAfterPageLoad = function (t3) {
                    return (
                      ...
                      e.dispatch('turbolinks:load', {
                        data: { url: this.location.absoluteURL, timing: t3 }
                      })
                    );
                  }),
                  (r.prototype.startVisit = function (t3, e2, r2) {
                    ...
                    return (
                      ...
                      (this.currentVisit = this.createVisit(t3, e2, r2)),
                      this.currentVisit.start(),
                      this.notifyApplicationAfterVisitingLocation(t3)
                    );
                  }),
                  ...
                  (r.prototype.getVisitableLinkForNode = function (t3) {
                    return this.nodeIsVisitable(t3)
                      ? e.closest(t3, 'a[href]:not([target]):not([download])')
                      : void 0;
                  }),
                  (r.prototype.getVisitableLocationForLink = function (t3) {
                    var r2;
                    return (
                      (r2 = new e.Location(t3.getAttribute('href'))),
                      this.locationIsVisitable(r2) ? r2 : void 0
                    );
                  }),
                  (r.prototype.getActionForLink = function (t3) {
                    var e2;
                    return null != (e2 = t3.getAttribute('data-turbolinks-action'))
                      ? e2
                      : 'advance';
                  }),
                  (r.prototype.nodeIsVisitable = function (t3) {
                    var r2;
                    return (r2 = e.closest(t3, '[data-turbolinks]'))
                      ? 'false' !== r2.getAttribute('data-turbolinks')
                      : true;
                  }),
            ...
            function () {
              !(function () {
                var t2, e2;
                if (
                  (t2 = e2 = document.currentScript) &&
                  !e2.hasAttribute('data-turbolinks-suppress-warning')
                ) {
            ...
            function () {
              ...
              (e.start = function () {
                return r()
                  ? (null == e.controller && (e.controller = t2()), e.controller.start())
                  : void 0;
              }),
                (r = function () {
    ...
    'node_modules/cash-dom/dist/cash.js'(exports, module) {
      (function () {
        ...
        function matches(ele, selector) {
          var matches2 =
            ele && (ele['matches'] || ele['webkitMatchesSelector'] || ele['msMatchesSelector']);
        ...
        function unique(arr) {
          return arr.length > 1
            ? filter.call(arr, function (item, index, self2) {
        ...
        function computeStyle(ele, prop, isVariable) {
          ...
          return isVariable
            ? style2.getPropertyValue(prop) || void 0
            : style2[prop] || ele.style[prop];
        }
        ...
        function getDocumentDimension(doc2, dimension) {
          ...
          return Math.max(
            doc2.body['scroll' + dimension],
            docEle2['scroll' + dimension],
            doc2.body['offset' + dimension],
            docEle2['offset' + dimension],
            docEle2['client' + dimension]
          );
        }
          ...
          each(['Width', 'Height'], function (i2, prop) {
            ...
            fn[name] = function (includeMargins) {
              ...
              if (isWindow(this[0]))
                return outer
                  ? this[0]['inner' + prop]
                  : this[0].document.documentElement['client' + prop];
              if (isDocument(this[0])) return getDocumentDimension(this[0], prop);
              return (
                this[0][(outer ? 'offset' : 'client') + prop] +
                (includeMargins && outer
                  ? computeStyleInt(this[0], 'margin' + (i2 ? 'Top' : 'Left')) +
                    computeStyleInt(this[0], 'margin' + (i2 ? 'Bottom' : 'Right'))
                  : 0)
              );
            };
          });
        ...
        fn.off = function (eventFullName, selector, callback) {
          ...
          if (isUndefined(eventFullName)) {
            ...
            each(getSplitValues(eventFullName), function (i, eventFullName2) {
              var _a = parseEventName(eventFullName2),
                nameOriginal = _a[0],
                namespaces = _a[1],
        ...
        function queryEncode(prop, value) {
          return (
            ...
            '=' +
            encodeURIComponent(value.replace(queryEncodeCRLFRe, '\r\n')).replace(
              queryEncodeSpaceRe,
              '+'
            )
          );
          ...
          this.each(function (i, ele) {
            each(ele.elements || [ele], function (i2, ele2) {
              if (
                ele2.disabled ||
                !ele2.name ||
                ele2.tagName === 'FIELDSET' ||
                skippableRe.test(ele2.type) ||
                (checkableRe.test(ele2.type) && !ele2.checked)
              )
                return;
        ...
        function parseHTML(html2) {
          ...
          if (singleTagRe.test(html2)) return [createElement(RegExp.$1)];
            ...
            .each(function (i, ele) {
              if (scriptTypeRe.test(ele.type) && docEle.contains(ele)) {
                ...
                each(scriptAttributes, function (i2, attr2) {
                  if (ele[attr2]) script_1[attr2] = ele[attr2];
                });
        ...
        fn.next = function (comparator, _all, _until) {
          return filtered(
            cash(unique(pluck(this, 'nextElementSibling', _all, _until))),
            comparator
          );
        };
        ...
        fn.prev = function (comparator, _all, _until) {
          return filtered(
            cash(unique(pluck(this, 'previousElementSibling', _all, _until))),
            comparator
          );
        };
  ...
  window.startListeningForEvents = () => {
    ...
    consumer.subscriptions.create(
      ...
      {
        received() {
          import_turbolinks.default.visit(window.location.toString(), {
            action: 'replace'
          });
        }
      }
  ...
  var checkSelected = () => {
    if (
      (0, import_cash_dom.default)('.check_selection .mustmark').find('.field input:checked')
        .length > 0
    ) {
      (0, import_cash_dom.default)('.check_selection .bottom-btn')
        .prop('disabled', false)
